...
function Navbar1() {
  return (
    <div className='text-xl font-bold text-[#1F1F1F] w-full flex items-center justify-between gap-x-4 py-9  px-4 border-b-1 border-gray-300'>
       ...
       <div className='h-full w-55'>
        ...
        {Object.keys(NavData1).map((key, index) => (
            <Link key={index} href={NavData1[key].link}  className='flex items-center gap-x-1 cursor-pointer hover:text-[#0a58ca] transition-colors duration-300'>
