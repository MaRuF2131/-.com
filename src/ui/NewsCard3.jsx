...
function NewsCard3({news}) {
  return (
    <Link href={`/news/${news?.id}`} className='group cursor-pointer w-full'>
        <Image src={news?.image || "/default.webp"} alt={news?.title} width={300} height={200} className='w-full h-full object-fill sm:max-h-auto max-h-[240px]' />
