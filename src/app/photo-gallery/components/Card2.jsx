...
function NewsCard2({news}) {
  return (
        <Link href={`photo-gallery/${news?._id}`} className='min-w-[250px] md:max-w-[300px] flex-1  group cursor-pointer text-black flex flex-col items-start justify-start w-full h-full p-2 gap-4  '>
