...
function page() {
  return (
          <div className="bg-white  mx-auto text-sm w-full   h-full text-black flex flex-wrap justify-between items-center px-6 py-3">
                    ...
                    <div className="w-full border-b border-gray-300 pb-5">
                        ...
                        <div className="grid md:grid-cols-4 grid-cols-3 md:gap-x-8 gap-x-4 gap-y-4 w-full">
